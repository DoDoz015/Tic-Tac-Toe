...
public:
    ...
    void setupUi(QDialog *ReplayGameWindow)
    {
        ...
        layoutWidget2 = new QWidget(ReplayGameWindow);
        layoutWidget2->setObjectName("layoutWidget2");
        layoutWidget2->setGeometry(QRect(30, 416, 101, 81));
        ...
        Home = new QPushButton(layoutWidget2);
        Home->setObjectName("Home");

        verticalLayout->addWidget(Home);

        labelWinner = new QLabel(ReplayGameWindow);
        labelWinner->setObjectName("labelWinner");
        labelWinner->setGeometry(QRect(410, 10, 281, 20));
    ...
    void retranslateUi(QDialog *ReplayGameWindow)
    {
        ...
        labelWinner->setText(QCoreApplication::translate("ReplayGameWindow", "TextLabel", nullptr));
    } // retranslateUi
